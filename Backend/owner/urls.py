...
from .views import OwnerRegistrationView, OwnerLoginView, VerifyOTP, OwnerProfileView, OwnerProfileUpdateView, OwnerBookingListView
...
urlpatterns = [
    ...
    path('bookings/<int:id>/', OwnerBookingListView.as_view(), name='bookings'),
]
