...
import { selectSelectedBike } from '../redux/Slices/userSlice';
...
function OwnerBikeEditComponent() {
    const { bikeId } = useParams();
    const selectedBikeId = useSelector(selectSelectedBike); 
    console.log(selectedBikeId,"Bike ID")
    ...
    console.log(Token.access,"TOKEN")
        ...
        useEffect(() => {
            ...
            const fetchBikeDetails = async () => {
                try {
                    const response = await axios.get(`http://127.0.0.1:8000/api/bike/details/${selectedBikeId}/`, {
                        headers: {
                    ...
                    setBikeDetails({
                        ...
                        year_of_registration: bike.year_of_registration,
                        city: bike.city,
                        bike_rent: bike.bike_rent,
                        images: null, 
                    });
                    setStartDate(new Date(bike.available_from));
                    setEndDate(new Date(bike.available_to));
                } catch (error) {
        ...
        const handleBikeSubmit = async (e) => {
            ...
            try {
                ...
                const response = await axios.post(`http://127.0.0.1:8000/api/bike/update_bike/${selectedBikeId}/`, formData, {
                    headers: {
        ...
        return (
            <>
                <form className="mt-10 mb-10" onSubmit={handleBikeSubmit}>
                    <h1 className="text-3xl font-bold text-black text-center mb-5">Edit Bike</h1>
...
export default OwnerBikeEditComponent