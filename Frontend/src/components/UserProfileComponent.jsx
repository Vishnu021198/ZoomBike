      ...
      <div className="w-full md:w-3/5 p-8 bg-white shadow-md">
        ...
        <div className="rounded shadow p-6">
          <div className="flex justify-between">
            ...
            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" className="mt-2 text-md font-bold text-white bg-gray-700 rounded-full px-5 py-2 hover:bg-gray-800" type="button">
              Edit
            </button>
          </div>
